...
urlpatterns = [
    ...
    path('generated_documents', views.generated_documents_view,
         name='generated_documents'),
    path('download_customized_docx', views.download_customized_docx,
         name='download_customized_docx'),
    path('download_test_and_generic_docx', views.download_test_and_generic_docx,
         name='download_test_and_generic_docx'),
    ...
    path('chapter_and_split_view', views.chapter_and_split_view,
         name='chapter_and_split_view'),
    ...
    path('display_split_table', views.display_split_table,
         name='display_split_table'),
    path('delete_subject_split', views.delete_subject_split,
         name='delete_subject_split'),
    ...
    path('get_customize_paper', views.get_customize_paper,
         name='get_customize_paper'),
    path('generate_optional_inputs', views.generate_optional_inputs,
         name='generate_optional_inputs'),
